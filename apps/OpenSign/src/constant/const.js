...
// Brand primary color. Runtime-configurable per deployment via the
// BRAND_COLOR env var (see entrypoint.sh); falls back to Pluvo blue.
export const themeColor =
  (window?.RUNTIME_ENV?.BRAND_COLOR || "").trim() || "#3E8FCB";
