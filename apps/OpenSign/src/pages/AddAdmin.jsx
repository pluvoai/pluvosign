...
const AddAdmin = () => {
  ...
  const checkUserExist = async () => {
    ...
    try {
      ...
      } else if (app?.user === "exist" && !isDemoHost()) {
        // On the demo URL, signup is intentionally always allowed (each
        // prospect gets their own demo tenant) — skip the gate.
            ...
            <div className="w-[95%] md:w-[500px]">
              <form onSubmit={handleSubmit}>
                <div className="w-full my-4 op-card bg-base-100 shadow-md outline outline-1 outline-slate-300/50">
                  ...
                  <h2 className="text-[24px] text-center mt-1 font-medium">
                  ...
                  <div className="px-6 py-3 text-xs">
                    ...
                    <div className="mt-2.5 ml-1 flex flex-row items-center">
                      ...
                      <span
                        ...
                        onClick={() =>
                          openInNewTab(
                            "https://pluvoai.com/pluvosign/terms"
                          )
                        }
                      >
                        {t("term")}
