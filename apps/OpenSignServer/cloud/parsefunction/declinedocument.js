...
async function sendDeclineMail(doc, publicUrl, userId, reason) {
  try {
    ...
    const logo =
      "<img src='https://sign.pluvoai.com/pluvosign-logo.png' height='50' style='padding:20px'/>";
    ...
    const body =
      ...
      `<div>${logo}</div><div style='padding:2px;font-family:system-ui;background-color:#3E8FCB'><p style='font-size:20px;font-weight:400;color:white;padding-left:20px'>Document declined by ${signerName}</p>` +
