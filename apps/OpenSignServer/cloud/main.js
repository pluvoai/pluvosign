...
import {
  withSendMailDemoLimit,
  withOtpDemoLimit,
  withDemoReject,
  withTenantAwareGetLogoByDomain,
  withDemoSignupNotification,
} from './demoLimits.js';
...
Parse.Cloud.define('sendmailv3', withSendMailDemoLimit(sendmailv3));
Parse.Cloud.define('usersignup', usersignup);
Parse.Cloud.define('SendOTPMailV1', withOtpDemoLimit(sendMailOTPv1));
...
Parse.Cloud.define('batchdocuments', withDemoReject(createBatchDocs, 'Bulk send is disabled in demo mode.'));
Parse.Cloud.define('linkcontacttodoc', linkContactToDoc);
Parse.Cloud.define('isextenduser', isextenduser);
Parse.Cloud.define('getlogobydomain', withTenantAwareGetLogoByDomain(GetLogoByDomain));
Parse.Cloud.define('addadmin', withDemoSignupNotification(AddAdmin));
...
Parse.Cloud.define('forwarddoc', withDemoReject(forwardDoc, 'Forwarding documents is disabled in demo mode.'));
